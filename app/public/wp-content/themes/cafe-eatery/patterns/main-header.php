...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:paragraph {"align":"center","style":{"color":{"text":"#323033"},"elements":{"link":{"color":{"text":"#323033"}}}},"fontSize":"medium"} -->
<p class="has-text-align-center has-text-color has-link-color has-medium-font-size" style="color:#323033"><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore Lorem ipsum dolor sit amet','cafe-eatery'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group logo" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:site-title {"textAlign":"center","style":{"typography":{"fontSize":"22px"},"elements":{"link":{"color":{"text":"var:preset|color|background"}}}},"textColor":"background"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center","width":"50%","className":"header-nav"} -->
<div class="wp-block-column is-vertically-aligned-center header-nav" style="flex-basis:50%"><!-- wp:navigation {"textColor":"background","overlayBackgroundColor":"foreground","overlayTextColor":"background","className":"head-menu-right","layout":{"type":"flex","justifyContent":"center"}} -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:15%"><!-- wp:woocommerce/customer-account {"displayStyle":"icon_only","iconClass":"wc-block-customer-account__account-icon","textColor":"background","fontSize":"tiny","style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}}}} /--></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center","width":"55%","fontSize":"small"} -->
<div class="wp-block-column is-vertically-aligned-center has-small-font-size" style="flex-basis:55%"><!-- wp:woocommerce/mini-cart {"hasHiddenPrice":false,"priceColor":{"slug":"background","color":"#ffffff","name":"Background","class":"has-background-price-color"},"iconColor":{"slug":"background","color":"#ffffff","name":"Background","class":"has-background-price-color"},"fontSize":"extra-small","style":{"typography":{"fontWeight":"700"}}} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
